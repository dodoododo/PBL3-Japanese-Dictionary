...
const DnDGame = () => {
    ...
    return(
        ...
        <h1 className="text-3xl lg:text-4xl font-bold text-center mb-6 text-primary my-18 pb-8">Pairing Kana</h1>
        ...
        <div className={`${game ? "hidden" : "flex"} flex-col border border-gray-300  min-h-100 dark:border-gray-600 rounded-xl px-8 py-10 shadow-lg bg-white dark:bg-gray-800 w-full max-w-4xl`}>
            <span className="text-2xl font-semibold text-center mb-6 text-gray-800 dark:text-white">Game Settings</span>
        ...
        <div className="flex flex-col items-center space-y-2">
            ...
            <button
                onClick={handleStart}
                className={`flex items-center gap-2 px-8 py-3 text-lg font-medium rounded-lg transition-all duration-150 ${
                isStartDisabled
        ...
        <div className={`${game ? "flex" : "hidden"} flex-col space-y-8 w-full max-w-5xl`}>
            ...
            <button
                onClick={handleBack}
                className="flex items-center gap-2 bg-blue-200 dark:bg-blue-600 hover:bg-blue-400 dark:hover:bg-blue-500 text-blue-900 dark:text-white px-5 py-2 rounded-lg transition"
            >
                <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <button
                onClick={handleReset}
                className="bg-yellow-300 hover:bg-yellow-400 text-black px-5 py-2 rounded-lg transition"
            >
                Reset
            </button>

            <div className="flex items-center gap-2 bg-green-200 dark:bg-green-600 px-4 py-2 rounded-lg text-lg">
                <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
